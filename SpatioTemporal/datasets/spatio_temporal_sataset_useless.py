...
这个dataset的时间负样本构建遵循year * num_tempo_neg_aug
"""
import os
import pandas as pd
import random
...
class Spatiotemporal_cityFolder(Dataset):
    """
    这个代码的数据集文件夹只包含不同城市, 但是会包含多个年份
    """
    pass
...
class SpatioTemporalDataset(Dataset):
    ...
    def __init__(self, root_folder, num_tempo_neg_aug=None, transform=None, transform_neg=None):
        """
        Args:
